...
public class TTransmitDataResult implements org.apache.thrift.TBase<TTransmitDataResult, TTransmitDataResult._Fields>, java.io.Serializable, Cloneable, Comparable<TTransmitDataResult> {
  ...
  public TTransmitDataResult setStatus(com.baidu.palo.thrift.TStatus status) {
    this.status = status;
    return this;
  }
  ...
  public TTransmitDataResult setDest_fragment_instance_id(com.baidu.palo.thrift.TUniqueId dest_fragment_instance_id) {

...
public class TListTableStatusResult implements org.apache.thrift.TBase<TListTableStatusResult, TListTableStatusResult._Fields>, java.io.Serializable, Cloneable, Comparable<TListTableStatusResult> {
  ...
  static {
    schemes.put(StandardScheme.class, new TListTableStatusResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TListTableStatusResultTupleSchemeFactory());
  }

  public List<TTableStatus> tables; // required
  ...
  public TListTableStatusResult(TListTableStatusResult other) {
    if (other.isSetTables()) {
      List<TTableStatus> __this__tables = new ArrayList<TTableStatus>(other.tables.size());
  ...
  public void addToTables(TTableStatus elem) {
    if (this.tables == null) {
      this.tables = new ArrayList<TTableStatus>();
    }
    this.tables.add(elem);
  }

  public List<TTableStatus> getTables() {
    return this.tables;
  }

  public TListTableStatusResult setTables(List<TTableStatus> tables) {
    this.tables = tables;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TABLES:
      if (value == null) {
        ...
        setTables((List<TTableStatus>)value);
      }
      break;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TListTableStatusResult(");
    boolean first = true;
  ...
  private static class TListTableStatusResultStandardSchemeFactory implements SchemeFactory {
    public TListTableStatusResultStandardScheme getScheme() {
      return new TListTableStatusResultStandardScheme();
    }
  }

  private static class TListTableStatusResultStandardScheme extends StandardScheme<TListTableStatusResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tables = new ArrayList<TTableStatus>(_list84.size);
                TTableStatus _elem85;
                for (int _i86 = 0; _i86 < _list84.size; ++_i86)
                {
                  _elem85 = new TTableStatus();
                  _elem85.read(iprot);
                  struct.tables.add(_elem85);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TListTableStatusResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.tables != null) {
        oprot.writeFieldBegin(TABLES_FIELD_DESC);
        {
          ...
          for (TTableStatus _iter87 : struct.tables)
          {
            _iter87.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TListTableStatusResultTupleSchemeFactory implements SchemeFactory {
    public TListTableStatusResultTupleScheme getScheme() {
      return new TListTableStatusResultTupleScheme();
    }
  }

  private static class TListTableStatusResultTupleScheme extends TupleScheme<TListTableStatusResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TListTableStatusResult struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (TTableStatus _iter88 : struct.tables)
        {
          _iter88.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TListTableStatusResult struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.tables = new ArrayList<TTableStatus>(_list89.size);
        TTableStatus _elem90;
        for (int _i91 = 0; _i91 < _list89.size; ++_i91)
        {
          _elem90 = new TTableStatus();
          _elem90.read(iprot);
          struct.tables.add(_elem90);
        }
      }
      struct.setTablesIsSet(true);
    }

...
public class TFeResult implements org.apache.thrift.TBase<TFeResult, TFeResult._Fields>, java.io.Serializable, Cloneable, Comparable<TFeResult> {
  ...
  static {
    schemes.put(StandardScheme.class, new TFeResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TFeResultTupleSchemeFactory());
  }
   ...
   * @see FrontendServiceVersion
   */
  public TFeResult setProtocolVersion(FrontendServiceVersion protocolVersion) {
    this.protocolVersion = protocolVersion;
    return this;
  }
  ...
  public TFeResult setStatus(com.baidu.palo.thrift.TStatus status) {
    this.status = status;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TFeResult(");
    boolean first = true;
  ...
  private static class TFeResultStandardSchemeFactory implements SchemeFactory {
    public TFeResultStandardScheme getScheme() {
      return new TFeResultStandardScheme();
    }
  }

  private static class TFeResultStandardScheme extends StandardScheme<TFeResult> {
  ...
  private static class TFeResultTupleSchemeFactory implements SchemeFactory {
    public TFeResultTupleScheme getScheme() {
      return new TFeResultTupleScheme();
    }
  }

  private static class TFeResultTupleScheme extends TupleScheme<TFeResult> {

...
public class TAnalyticWindowBoundary implements org.apache.thrift.TBase<TAnalyticWindowBoundary, TAnalyticWindowBoundary._Fields>, java.io.Serializable, Cloneable, Comparable<TAnalyticWindowBoundary> {
  ...
  public com.baidu.palo.thrift.TExpr range_offset_predicate; // optional
  ...
  public TAnalyticWindowBoundary(TAnalyticWindowBoundary other) {
    ...
    if (other.isSetRange_offset_predicate()) {
      this.range_offset_predicate = new com.baidu.palo.thrift.TExpr(other.range_offset_predicate);
    }
  ...
  public com.baidu.palo.thrift.TExpr getRange_offset_predicate() {
    return this.range_offset_predicate;
  }

  public TAnalyticWindowBoundary setRange_offset_predicate(com.baidu.palo.thrift.TExpr range_offset_predicate) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RANGE_OFFSET_PREDICATE:
      if (value == null) {
        ...
        setRange_offset_predicate((com.baidu.palo.thrift.TExpr)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.baidu.palo.thrift.TAnalyticWindowBoundaryType.findByValue(iprot.readI32());
          ...
          case 2: // RANGE_OFFSET_PREDICATE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.range_offset_predicate = new com.baidu.palo.thrift.TExpr();

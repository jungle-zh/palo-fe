...
public class TCounter implements org.apache.thrift.TBase<TCounter, TCounter._Fields>, java.io.Serializable, Cloneable, Comparable<TCounter> {
   ...
   */
  public com.baidu.palo.thrift.TUnit type; // required
  ...
  public TCounter(
    String name,
    com.baidu.palo.thrift.TUnit type,
    long value)
  {
    this();
    this.name = name;
   ...
   * @see com.baidu.palo.thrift.TUnit
   */
  public com.baidu.palo.thrift.TUnit getType() {
    return this.type;
  }
   ...
   * @see com.baidu.palo.thrift.TUnit
   */
  public TCounter setType(com.baidu.palo.thrift.TUnit type) {
    this.type = type;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TYPE:
      if (value == null) {
        ...
        setType((com.baidu.palo.thrift.TUnit)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 2: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.baidu.palo.thrift.TUnit.findByValue(iprot.readI32());

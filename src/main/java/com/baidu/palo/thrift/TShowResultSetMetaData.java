...
public class TShowResultSetMetaData implements org.apache.thrift.TBase<TShowResultSetMetaData, TShowResultSetMetaData._Fields>, java.io.Serializable, Cloneable, Comparable<TShowResultSetMetaData> {
  ...
  static {
    schemes.put(StandardScheme.class, new TShowResultSetMetaDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TShowResultSetMetaDataTupleSchemeFactory());
  }

  public List<TColumnDefinition> columns; // required
  ...
  public TShowResultSetMetaData(
    List<TColumnDefinition> columns)
  {
    this();
  ...
  public TShowResultSetMetaData(TShowResultSetMetaData other) {
    if (other.isSetColumns()) {
      List<TColumnDefinition> __this__columns = new ArrayList<TColumnDefinition>(other.columns.size());
  ...
  public void addToColumns(TColumnDefinition elem) {
    if (this.columns == null) {
      this.columns = new ArrayList<TColumnDefinition>();
    }
    this.columns.add(elem);
  }

  public List<TColumnDefinition> getColumns() {
    return this.columns;
  }

  public TShowResultSetMetaData setColumns(List<TColumnDefinition> columns) {
    this.columns = columns;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case COLUMNS:
      if (value == null) {
        ...
        setColumns((List<TColumnDefinition>)value);
      }
      break;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TShowResultSetMetaData(");
    boolean first = true;
  ...
  private static class TShowResultSetMetaDataStandardSchemeFactory implements SchemeFactory {
    public TShowResultSetMetaDataStandardScheme getScheme() {
      return new TShowResultSetMetaDataStandardScheme();
    }
  }

  private static class TShowResultSetMetaDataStandardScheme extends StandardScheme<TShowResultSetMetaData> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new ArrayList<TColumnDefinition>(_list152.size);
                TColumnDefinition _elem153;
                for (int _i154 = 0; _i154 < _list152.size; ++_i154)
                {
                  _elem153 = new TColumnDefinition();
                  _elem153.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TShowResultSetMetaData struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (TColumnDefinition _iter155 : struct.columns)
          {
  ...
  private static class TShowResultSetMetaDataTupleSchemeFactory implements SchemeFactory {
    public TShowResultSetMetaDataTupleScheme getScheme() {
      return new TShowResultSetMetaDataTupleScheme();
    }
  }

  private static class TShowResultSetMetaDataTupleScheme extends TupleScheme<TShowResultSetMetaData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TShowResultSetMetaData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (TColumnDefinition _iter156 : struct.columns)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TShowResultSetMetaData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.columns = new ArrayList<TColumnDefinition>(_list157.size);
        TColumnDefinition _elem158;
        for (int _i159 = 0; _i159 < _list157.size; ++_i159)
        {
          _elem158 = new TColumnDefinition();
          _elem158.read(iprot);

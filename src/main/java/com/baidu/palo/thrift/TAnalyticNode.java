...
public class TAnalyticNode implements org.apache.thrift.TBase<TAnalyticNode, TAnalyticNode._Fields>, java.io.Serializable, Cloneable, Comparable<TAnalyticNode> {
  ...
  public List<com.baidu.palo.thrift.TExpr> order_by_exprs; // required
  public List<com.baidu.palo.thrift.TExpr> analytic_functions; // required
  ...
  public com.baidu.palo.thrift.TExpr partition_by_eq; // optional
  public com.baidu.palo.thrift.TExpr order_by_eq; // optional
  ...
  public TAnalyticNode(
    ...
    List<com.baidu.palo.thrift.TExpr> order_by_exprs,
    List<com.baidu.palo.thrift.TExpr> analytic_functions,
  ...
  public TAnalyticNode(TAnalyticNode other) {
    ...
    if (other.isSetOrder_by_exprs()) {
      List<com.baidu.palo.thrift.TExpr> __this__order_by_exprs = new ArrayList<com.baidu.palo.thrift.TExpr>(other.order_by_exprs.size());
      for (com.baidu.palo.thrift.TExpr other_element : other.order_by_exprs) {
        __this__order_by_exprs.add(new com.baidu.palo.thrift.TExpr(other_element));
      }
      this.order_by_exprs = __this__order_by_exprs;
    }
    if (other.isSetAnalytic_functions()) {
      List<com.baidu.palo.thrift.TExpr> __this__analytic_functions = new ArrayList<com.baidu.palo.thrift.TExpr>(other.analytic_functions.size());
      for (com.baidu.palo.thrift.TExpr other_element : other.analytic_functions) {
        __this__analytic_functions.add(new com.baidu.palo.thrift.TExpr(other_element));
      }
    ...
    if (other.isSetPartition_by_eq()) {
      this.partition_by_eq = new com.baidu.palo.thrift.TExpr(other.partition_by_eq);
    }
    if (other.isSetOrder_by_eq()) {
      this.order_by_eq = new com.baidu.palo.thrift.TExpr(other.order_by_eq);
    }
  }
  ...
  public TAnalyticNode setPartition_exprs(List<com.baidu.palo.thrift.TExpr> partition_exprs) {
    this.partition_exprs = partition_exprs;
    return this;
  }
  ...
  public java.util.Iterator<com.baidu.palo.thrift.TExpr> getOrder_by_exprsIterator() {
    return (this.order_by_exprs == null) ? null : this.order_by_exprs.iterator();
  }

  public void addToOrder_by_exprs(com.baidu.palo.thrift.TExpr elem) {
    if (this.order_by_exprs == null) {
      this.order_by_exprs = new ArrayList<com.baidu.palo.thrift.TExpr>();
    }
    this.order_by_exprs.add(elem);
  }

  public List<com.baidu.palo.thrift.TExpr> getOrder_by_exprs() {
    return this.order_by_exprs;
  }

  public TAnalyticNode setOrder_by_exprs(List<com.baidu.palo.thrift.TExpr> order_by_exprs) {
    this.order_by_exprs = order_by_exprs;
    return this;
  }
  ...
  public java.util.Iterator<com.baidu.palo.thrift.TExpr> getAnalytic_functionsIterator() {
    return (this.analytic_functions == null) ? null : this.analytic_functions.iterator();
  }

  public void addToAnalytic_functions(com.baidu.palo.thrift.TExpr elem) {
    if (this.analytic_functions == null) {
      this.analytic_functions = new ArrayList<com.baidu.palo.thrift.TExpr>();
    }
    this.analytic_functions.add(elem);
  }

  public List<com.baidu.palo.thrift.TExpr> getAnalytic_functions() {
    return this.analytic_functions;
  }

  public TAnalyticNode setAnalytic_functions(List<com.baidu.palo.thrift.TExpr> analytic_functions) {
    this.analytic_functions = analytic_functions;
    return this;
  }
  ...
  public com.baidu.palo.thrift.TExpr getPartition_by_eq() {
    return this.partition_by_eq;
  }

  public TAnalyticNode setPartition_by_eq(com.baidu.palo.thrift.TExpr partition_by_eq) {
  ...
  public com.baidu.palo.thrift.TExpr getOrder_by_eq() {
    return this.order_by_eq;
  }

  public TAnalyticNode setOrder_by_eq(com.baidu.palo.thrift.TExpr order_by_eq) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ORDER_BY_EXPRS:
      if (value == null) {
        ...
        setOrder_by_exprs((List<com.baidu.palo.thrift.TExpr>)value);
      }
      break;
    ...
    case ANALYTIC_FUNCTIONS:
      if (value == null) {
        ...
        setAnalytic_functions((List<com.baidu.palo.thrift.TExpr>)value);
      }
      break;
    ...
    case PARTITION_BY_EQ:
      if (value == null) {
        ...
        setPartition_by_eq((com.baidu.palo.thrift.TExpr)value);
      }
      break;
    ...
    case ORDER_BY_EQ:
      if (value == null) {
        ...
        setOrder_by_eq((com.baidu.palo.thrift.TExpr)value);
      }
      break;
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TAnalyticNode struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new ArrayList<com.baidu.palo.thrift.TExpr>(_list296.size);
                com.baidu.palo.thrift.TExpr _elem297;
                for (int _i298 = 0; _i298 < _list296.size; ++_i298)
                {
                  _elem297 = new com.baidu.palo.thrift.TExpr();
                  _elem297.read(iprot);
                  struct.partition_exprs.add(_elem297);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.order_by_exprs = new ArrayList<com.baidu.palo.thrift.TExpr>(_list299.size);
                com.baidu.palo.thrift.TExpr _elem300;
                for (int _i301 = 0; _i301 < _list299.size; ++_i301)
                {
                  _elem300 = new com.baidu.palo.thrift.TExpr();
                  _elem300.read(iprot);
                  struct.order_by_exprs.add(_elem300);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.analytic_functions = new ArrayList<com.baidu.palo.thrift.TExpr>(_list302.size);
                com.baidu.palo.thrift.TExpr _elem303;
                for (int _i304 = 0; _i304 < _list302.size; ++_i304)
                {
                  _elem303 = new com.baidu.palo.thrift.TExpr();
                  _elem303.read(iprot);
                  struct.analytic_functions.add(_elem303);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // PARTITION_BY_EQ
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.partition_by_eq = new com.baidu.palo.thrift.TExpr();
          ...
          case 9: // ORDER_BY_EQ
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.order_by_eq = new com.baidu.palo.thrift.TExpr();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAnalyticNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.partition_exprs != null) {
        oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
        {
          ...
          for (com.baidu.palo.thrift.TExpr _iter305 : struct.partition_exprs)
          {
      ...
      if (struct.order_by_exprs != null) {
        oprot.writeFieldBegin(ORDER_BY_EXPRS_FIELD_DESC);
        {
          ...
          for (com.baidu.palo.thrift.TExpr _iter306 : struct.order_by_exprs)
          {
      ...
      if (struct.analytic_functions != null) {
        oprot.writeFieldBegin(ANALYTIC_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (com.baidu.palo.thrift.TExpr _iter307 : struct.analytic_functions)
          {
  ...
  private static class TAnalyticNodeTupleScheme extends TupleScheme<TAnalyticNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAnalyticNode struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (com.baidu.palo.thrift.TExpr _iter308 : struct.partition_exprs)
        {
      ...
      }
      {
        ...
        for (com.baidu.palo.thrift.TExpr _iter309 : struct.order_by_exprs)
        {
      ...
      }
      {
        ...
        for (com.baidu.palo.thrift.TExpr _iter310 : struct.analytic_functions)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAnalyticNode struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.partition_exprs = new ArrayList<com.baidu.palo.thrift.TExpr>(_list311.size);
        com.baidu.palo.thrift.TExpr _elem312;
        for (int _i313 = 0; _i313 < _list311.size; ++_i313)
        {
          _elem312 = new com.baidu.palo.thrift.TExpr();
          _elem312.read(iprot);
          struct.partition_exprs.add(_elem312);
        }
      }
      struct.setPartition_exprsIsSet(true);
      {
        ...
        struct.order_by_exprs = new ArrayList<com.baidu.palo.thrift.TExpr>(_list314.size);
        com.baidu.palo.thrift.TExpr _elem315;
        for (int _i316 = 0; _i316 < _list314.size; ++_i316)
        {
          _elem315 = new com.baidu.palo.thrift.TExpr();
          _elem315.read(iprot);
          struct.order_by_exprs.add(_elem315);
        }
      }
      struct.setOrder_by_exprsIsSet(true);
      {
        ...
        struct.analytic_functions = new ArrayList<com.baidu.palo.thrift.TExpr>(_list317.size);
        com.baidu.palo.thrift.TExpr _elem318;
        for (int _i319 = 0; _i319 < _list317.size; ++_i319)
        {
          _elem318 = new com.baidu.palo.thrift.TExpr();
          _elem318.read(iprot);
          struct.analytic_functions.add(_elem318);
        }
      }
      struct.setAnalytic_functionsIsSet(true);
      struct.intermediate_tuple_id = iprot.readI32();

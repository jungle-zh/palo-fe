...
public class TEqJoinCondition implements org.apache.thrift.TBase<TEqJoinCondition, TEqJoinCondition._Fields>, java.io.Serializable, Cloneable, Comparable<TEqJoinCondition> {
  ...
  public com.baidu.palo.thrift.TExpr left; // required
  public com.baidu.palo.thrift.TExpr right; // required
  ...
  public TEqJoinCondition(
    com.baidu.palo.thrift.TExpr left,
    com.baidu.palo.thrift.TExpr right)
  {
    this();
    this.left = left;
    this.right = right;
  ...
  public TEqJoinCondition(TEqJoinCondition other) {
    if (other.isSetLeft()) {
      this.left = new com.baidu.palo.thrift.TExpr(other.left);
    }
    if (other.isSetRight()) {
      this.right = new com.baidu.palo.thrift.TExpr(other.right);
    }
  }
  ...
  public com.baidu.palo.thrift.TExpr getLeft() {
    return this.left;
  }

  public TEqJoinCondition setLeft(com.baidu.palo.thrift.TExpr left) {
    this.left = left;
    return this;
  }
  ...
  public com.baidu.palo.thrift.TExpr getRight() {
    return this.right;
  }

  public TEqJoinCondition setRight(com.baidu.palo.thrift.TExpr right) {
    this.right = right;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LEFT:
      if (value == null) {
        ...
        setLeft((com.baidu.palo.thrift.TExpr)value);
      }
      break;
    ...
    case RIGHT:
      if (value == null) {
        ...
        setRight((com.baidu.palo.thrift.TExpr)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // LEFT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.left = new com.baidu.palo.thrift.TExpr();
          ...
          case 2: // RIGHT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.right = new com.baidu.palo.thrift.TExpr();

...
public class TFinishTaskRequest implements org.apache.thrift.TBase<TFinishTaskRequest, TFinishTaskRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TFinishTaskRequest> {
  ...
  private static final int __TASK_ID_ISSET_ID = 5;
  private static final int __JOB_ID_ISSET_ID = 6;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.REPORT_VERSION,_Fields.FINISH_TABLET_INFOS,_Fields.TABLET_CHECKSUM,_Fields.REQUEST_VERSION,_Fields.REQUEST_VERSION_HASH,_Fields.SNAPSHOT_PATH,_Fields.TASK_ID,_Fields.JOB_ID};
  ...
  public TFinishTaskRequest setTask_id(long task_id) {
  ...
  public TFinishTaskRequest setJob_id(long job_id) {
    this.job_id = job_id;
    setJob_idIsSet(true);
    return this;
  }

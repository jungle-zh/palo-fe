...
public class TCreateTableParams implements org.apache.thrift.TBase<TCreateTableParams, TCreateTableParams._Fields>, java.io.Serializable, Cloneable, Comparable<TCreateTableParams> {
  ...
  public TCreateTableParams setEngine_name(String engine_name) {
    this.engine_name = engine_name;
    return this;
  }

  public void unsetEngine_name() {
    this.engine_name = null;
  }

  /** Returns true if field engine_name is set (has been assigned a value) and false otherwise */
  public boolean isSetEngine_name() {
    return this.engine_name != null;
  }

  public void setEngine_nameIsSet(boolean value) {
    if (!value) {
      this.engine_name = null;
    }
  }
  ...
  public TCreateTableParams setPartition_desc(TPartitionDesc partition_desc) {
  ...
  public String getRow_format_type() {
    return this.row_format_type;
  }

  public TCreateTableParams setRow_format_type(String row_format_type) {
    this.row_format_type = row_format_type;
    return this;
  }

  public void unsetRow_format_type() {
    this.row_format_type = null;
  }

  /** Returns true if field row_format_type is set (has been assigned a value) and false otherwise */
  public boolean isSetRow_format_type() {
    return this.row_format_type != null;
  }

  public void setRow_format_typeIsSet(boolean value) {
    if (!value) {
      this.row_format_type = null;
    }
  }
  ...
  public TCreateTableParams setProperties(Map<String,String> properties) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ROW_FORMAT_TYPE:
      if (value == null) {
        unsetRow_format_type();
      } else {
        setRow_format_type((String)value);
      }
      break;
  ...
  public boolean equals(TCreateTableParams that) {
    ...
    boolean this_present_engine_name = true && this.isSetEngine_name();
    boolean that_present_engine_name = true && that.isSetEngine_name();
    ...
    boolean this_present_row_format_type = true && this.isSetRow_format_type();
    boolean that_present_row_format_type = true && that.isSetRow_format_type();
  ...
  public int hashCode() {
    ...
    boolean present_engine_name = true && (isSetEngine_name());
    list.add(present_engine_name);
    if (present_engine_name)
      list.add(engine_name);
    ...
    boolean present_row_format_type = true && (isSetRow_format_type());
    list.add(present_row_format_type);
    if (present_row_format_type)
      list.add(row_format_type);
  ...
  public int compareTo(TCreateTableParams other) {
    ...
    lastComparison = Boolean.valueOf(isSetEngine_name()).compareTo(other.isSetEngine_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEngine_name()) {
    ...
    lastComparison = Boolean.valueOf(isSetRow_format_type()).compareTo(other.isSetRow_format_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRow_format_type()) {
  ...
  private static class TCreateTableParamsStandardScheme extends StandardScheme<TCreateTableParams> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // ENGINE_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              ...
              struct.setEngine_nameIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          ...
          case 6: // ROW_FORMAT_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              ...
              struct.setRow_format_typeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCreateTableParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.row_format_type != null) {
        if (struct.isSetRow_format_type()) {

...
public class TTupleDescriptor implements org.apache.thrift.TBase<TTupleDescriptor, TTupleDescriptor._Fields>, java.io.Serializable, Cloneable, Comparable<TTupleDescriptor> {
  ...
  public void unsetNumNullSlots() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __NUMNULLSLOTS_ISSET_ID);
  }

  /** Returns true if field numNullSlots is set (has been assigned a value) and false otherwise */
  public boolean isSetNumNullSlots() {
    return EncodingUtils.testBit(__isset_bitfield, __NUMNULLSLOTS_ISSET_ID);
  }

  public void setNumNullSlotsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __NUMNULLSLOTS_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_numNullSlots = true && (isSetNumNullSlots());
    list.add(present_numNullSlots);
    if (present_numNullSlots)
      list.add(numNullSlots);
  ...
  public int compareTo(TTupleDescriptor other) {
    ...
    lastComparison = Boolean.valueOf(isSetNumNullSlots()).compareTo(other.isSetNumNullSlots());
    if (lastComparison != 0) {
      return lastComparison;
    }

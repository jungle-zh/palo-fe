...
public class TBackendInfo implements org.apache.thrift.TBase<TBackendInfo, TBackendInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TBackendInfo> {
  ...
  static {
    schemes.put(StandardScheme.class, new TBackendInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TBackendInfoTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.BE_RPC_PORT};
  ...
  public void unsetBe_rpc_port() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __BE_RPC_PORT_ISSET_ID);
  }

  /** Returns true if field be_rpc_port is set (has been assigned a value) and false otherwise */
  public boolean isSetBe_rpc_port() {
    return EncodingUtils.testBit(__isset_bitfield, __BE_RPC_PORT_ISSET_ID);
  }

  public void setBe_rpc_portIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __BE_RPC_PORT_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_be_port = true;
    list.add(present_be_port);
    if (present_be_port)
      list.add(be_port);

    boolean present_http_port = true;
    list.add(present_http_port);
    if (present_http_port)
      list.add(http_port);

    boolean present_be_rpc_port = true && (isSetBe_rpc_port());
    list.add(present_be_rpc_port);
    if (present_be_rpc_port)
      list.add(be_rpc_port);
  ...
  public int compareTo(TBackendInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetBe_rpc_port()).compareTo(other.isSetBe_rpc_port());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBe_rpc_port()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TBackendInfo(");
    boolean first = true;
  ...
  private static class TBackendInfoStandardSchemeFactory implements SchemeFactory {
    public TBackendInfoStandardScheme getScheme() {
      return new TBackendInfoStandardScheme();
    }
  }

  private static class TBackendInfoStandardScheme extends StandardScheme<TBackendInfo> {
  ...
  private static class TBackendInfoTupleSchemeFactory implements SchemeFactory {
    public TBackendInfoTupleScheme getScheme() {
      return new TBackendInfoTupleScheme();
    }
  }

  private static class TBackendInfoTupleScheme extends TupleScheme<TBackendInfo> {

...
public class TKuduPartitionByRangeParam implements org.apache.thrift.TBase<TKuduPartitionByRangeParam, TKuduPartitionByRangeParam._Fields>, java.io.Serializable, Cloneable, Comparable<TKuduPartitionByRangeParam> {
  ...
  public List<TKuduRangePartition> range_partitions; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.RANGE_PARTITIONS, new org.apache.thrift.meta_data.FieldMetaData("range_partitions", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TKuduRangePartition.class))));
  ...
  public TKuduPartitionByRangeParam(TKuduPartitionByRangeParam other) {
    ...
    if (other.isSetRange_partitions()) {
      List<TKuduRangePartition> __this__range_partitions = new ArrayList<TKuduRangePartition>(other.range_partitions.size());
      for (TKuduRangePartition other_element : other.range_partitions) {
        __this__range_partitions.add(new TKuduRangePartition(other_element));
      }
  ...
  public java.util.Iterator<TKuduRangePartition> getRange_partitionsIterator() {
    return (this.range_partitions == null) ? null : this.range_partitions.iterator();
  }

  public void addToRange_partitions(TKuduRangePartition elem) {
    if (this.range_partitions == null) {
      this.range_partitions = new ArrayList<TKuduRangePartition>();
    }
    this.range_partitions.add(elem);
  }

  public List<TKuduRangePartition> getRange_partitions() {
    return this.range_partitions;
  }

  public TKuduPartitionByRangeParam setRange_partitions(List<TKuduRangePartition> range_partitions) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RANGE_PARTITIONS:
      if (value == null) {
        ...
        setRange_partitions((List<TKuduRangePartition>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new ArrayList<String>(_list24.size);
                String _elem25;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.range_partitions = new ArrayList<TKuduRangePartition>(_list27.size);
                TKuduRangePartition _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new TKuduRangePartition();
                  _elem28.read(iprot);
                  struct.range_partitions.add(_elem28);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TKuduPartitionByRangeParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (String _iter30 : struct.columns)
          {
      ...
      if (struct.range_partitions != null) {
        if (struct.isSetRange_partitions()) {
          oprot.writeFieldBegin(RANGE_PARTITIONS_FIELD_DESC);
          {
            ...
            for (TKuduRangePartition _iter31 : struct.range_partitions)
            {
              _iter31.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetRange_partitions()) {
        {
          ...
          for (TKuduRangePartition _iter33 : struct.range_partitions)
          {
            _iter33.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.range_partitions = new ArrayList<TKuduRangePartition>(_list37.size);
          TKuduRangePartition _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new TKuduRangePartition();
            _elem38.read(iprot);
            struct.range_partitions.add(_elem38);
          }
        }
        struct.setRange_partitionsIsSet(true);
      }

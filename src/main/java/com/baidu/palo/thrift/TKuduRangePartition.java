...
public class TKuduRangePartition implements org.apache.thrift.TBase<TKuduRangePartition, TKuduRangePartition._Fields>, java.io.Serializable, Cloneable, Comparable<TKuduRangePartition> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TKuduRangePartition");
  ...
  static {
    schemes.put(StandardScheme.class, new TKuduRangePartitionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TKuduRangePartitionTupleSchemeFactory());
  }

  public List<com.baidu.palo.thrift.TExpr> lower_bound_values; // optional
  public boolean is_lower_bound_inclusive; // optional
  public List<com.baidu.palo.thrift.TExpr> upper_bound_values; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TKuduRangePartition.class, metaDataMap);
  }

  public TKuduRangePartition() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TKuduRangePartition(TKuduRangePartition other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetLower_bound_values()) {
      List<com.baidu.palo.thrift.TExpr> __this__lower_bound_values = new ArrayList<com.baidu.palo.thrift.TExpr>(other.lower_bound_values.size());
      for (com.baidu.palo.thrift.TExpr other_element : other.lower_bound_values) {
        __this__lower_bound_values.add(new com.baidu.palo.thrift.TExpr(other_element));
      }
    ...
    if (other.isSetUpper_bound_values()) {
      List<com.baidu.palo.thrift.TExpr> __this__upper_bound_values = new ArrayList<com.baidu.palo.thrift.TExpr>(other.upper_bound_values.size());
      for (com.baidu.palo.thrift.TExpr other_element : other.upper_bound_values) {
        __this__upper_bound_values.add(new com.baidu.palo.thrift.TExpr(other_element));
      }
  ...
  public TKuduRangePartition deepCopy() {
    return new TKuduRangePartition(this);
  }
  ...
  public java.util.Iterator<com.baidu.palo.thrift.TExpr> getLower_bound_valuesIterator() {
    return (this.lower_bound_values == null) ? null : this.lower_bound_values.iterator();
  }

  public void addToLower_bound_values(com.baidu.palo.thrift.TExpr elem) {
    if (this.lower_bound_values == null) {
      this.lower_bound_values = new ArrayList<com.baidu.palo.thrift.TExpr>();
    }
    this.lower_bound_values.add(elem);
  }

  public List<com.baidu.palo.thrift.TExpr> getLower_bound_values() {
    return this.lower_bound_values;
  }

  public TKuduRangePartition setLower_bound_values(List<com.baidu.palo.thrift.TExpr> lower_bound_values) {
  ...
  public TKuduRangePartition setIs_lower_bound_inclusive(boolean is_lower_bound_inclusive) {
  ...
  public java.util.Iterator<com.baidu.palo.thrift.TExpr> getUpper_bound_valuesIterator() {
    return (this.upper_bound_values == null) ? null : this.upper_bound_values.iterator();
  }

  public void addToUpper_bound_values(com.baidu.palo.thrift.TExpr elem) {
    if (this.upper_bound_values == null) {
      this.upper_bound_values = new ArrayList<com.baidu.palo.thrift.TExpr>();
    }
    this.upper_bound_values.add(elem);
  }

  public List<com.baidu.palo.thrift.TExpr> getUpper_bound_values() {
    return this.upper_bound_values;
  }

  public TKuduRangePartition setUpper_bound_values(List<com.baidu.palo.thrift.TExpr> upper_bound_values) {
  ...
  public TKuduRangePartition setIs_upper_bound_inclusive(boolean is_upper_bound_inclusive) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LOWER_BOUND_VALUES:
      if (value == null) {
        ...
        setLower_bound_values((List<com.baidu.palo.thrift.TExpr>)value);
      }
      break;
    ...
    case UPPER_BOUND_VALUES:
      if (value == null) {
        ...
        setUpper_bound_values((List<com.baidu.palo.thrift.TExpr>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TKuduRangePartition)
      return this.equals((TKuduRangePartition)that);
    return false;
  }

  public boolean equals(TKuduRangePartition that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TKuduRangePartition other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TKuduRangePartition(");
    boolean first = true;
  ...
  private static class TKuduRangePartitionStandardSchemeFactory implements SchemeFactory {
    public TKuduRangePartitionStandardScheme getScheme() {
      return new TKuduRangePartitionStandardScheme();
    }
  }

  private static class TKuduRangePartitionStandardScheme extends StandardScheme<TKuduRangePartition> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TKuduRangePartition struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.lower_bound_values = new ArrayList<com.baidu.palo.thrift.TExpr>(_list8.size);
                com.baidu.palo.thrift.TExpr _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new com.baidu.palo.thrift.TExpr();
                  _elem9.read(iprot);
                  struct.lower_bound_values.add(_elem9);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.upper_bound_values = new ArrayList<com.baidu.palo.thrift.TExpr>(_list11.size);
                com.baidu.palo.thrift.TExpr _elem12;
                for (int _i13 = 0; _i13 < _list11.size; ++_i13)
                {
                  _elem12 = new com.baidu.palo.thrift.TExpr();
                  _elem12.read(iprot);
                  struct.upper_bound_values.add(_elem12);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TKuduRangePartition struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.lower_bound_values != null) {
        if (struct.isSetLower_bound_values()) {
          oprot.writeFieldBegin(LOWER_BOUND_VALUES_FIELD_DESC);
          {
            ...
            for (com.baidu.palo.thrift.TExpr _iter14 : struct.lower_bound_values)
            {
              _iter14.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.upper_bound_values != null) {
        if (struct.isSetUpper_bound_values()) {
          oprot.writeFieldBegin(UPPER_BOUND_VALUES_FIELD_DESC);
          {
            ...
            for (com.baidu.palo.thrift.TExpr _iter15 : struct.upper_bound_values)
            {
              _iter15.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TKuduRangePartitionTupleSchemeFactory implements SchemeFactory {
    public TKuduRangePartitionTupleScheme getScheme() {
      return new TKuduRangePartitionTupleScheme();
    }
  }

  private static class TKuduRangePartitionTupleScheme extends TupleScheme<TKuduRangePartition> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TKuduRangePartition struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetLower_bound_values()) {
        {
          ...
          for (com.baidu.palo.thrift.TExpr _iter16 : struct.lower_bound_values)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (struct.isSetUpper_bound_values()) {
        {
          ...
          for (com.baidu.palo.thrift.TExpr _iter17 : struct.upper_bound_values)
          {
            _iter17.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TKuduRangePartition struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(4);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list18 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.lower_bound_values = new ArrayList<com.baidu.palo.thrift.TExpr>(_list18.size);
          com.baidu.palo.thrift.TExpr _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new com.baidu.palo.thrift.TExpr();
            _elem19.read(iprot);
            struct.lower_bound_values.add(_elem19);
          }
        }
        struct.setLower_bound_valuesIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.upper_bound_values = new ArrayList<com.baidu.palo.thrift.TExpr>(_list21.size);
          com.baidu.palo.thrift.TExpr _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new com.baidu.palo.thrift.TExpr();
            _elem22.read(iprot);
            struct.upper_bound_values.add(_elem22);
          }
        }
        struct.setUpper_bound_valuesIsSet(true);
      }

...
public class TResultSink implements org.apache.thrift.TBase<TResultSink, TResultSink._Fields>, java.io.Serializable, Cloneable, Comparable<TResultSink> {
  ...
  static {
    schemes.put(StandardScheme.class, new TResultSinkStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TResultSinkTupleSchemeFactory());
  }
...
;
  ...
  private static class TResultSinkStandardSchemeFactory implements SchemeFactory {
    public TResultSinkStandardScheme getScheme() {
      return new TResultSinkStandardScheme();
    }
  }

  private static class TResultSinkStandardScheme extends StandardScheme<TResultSink> {
  ...
  private static class TResultSinkTupleSchemeFactory implements SchemeFactory {
    public TResultSinkTupleScheme getScheme() {
      return new TResultSinkTupleScheme();
    }
  }

  private static class TResultSinkTupleScheme extends TupleScheme<TResultSink> {

...
public class TReleaseSnapshotRequest implements org.apache.thrift.TBase<TReleaseSnapshotRequest, TReleaseSnapshotRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TReleaseSnapshotRequest> {
  ...
  static {
    schemes.put(StandardScheme.class, new TReleaseSnapshotRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TReleaseSnapshotRequestTupleSchemeFactory());
  }
  ...
  public TReleaseSnapshotRequest setSnapshot_path(String snapshot_path) {
    this.snapshot_path = snapshot_path;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TReleaseSnapshotRequest(");
    boolean first = true;
  ...
  private static class TReleaseSnapshotRequestStandardSchemeFactory implements SchemeFactory {
    public TReleaseSnapshotRequestStandardScheme getScheme() {
      return new TReleaseSnapshotRequestStandardScheme();
    }
  }

  private static class TReleaseSnapshotRequestStandardScheme extends StandardScheme<TReleaseSnapshotRequest> {
  ...
  private static class TReleaseSnapshotRequestTupleSchemeFactory implements SchemeFactory {
    public TReleaseSnapshotRequestTupleScheme getScheme() {
      return new TReleaseSnapshotRequestTupleScheme();
    }
  }

  private static class TReleaseSnapshotRequestTupleScheme extends TupleScheme<TReleaseSnapshotRequest> {

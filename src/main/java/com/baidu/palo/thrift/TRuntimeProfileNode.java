            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.counters = new ArrayList<TCounter>(_list0.size);
                TCounter _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.info_strings = new HashMap<String,String>(2*_map3.size);
                String _key4;
                String _val5;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.info_strings_display_order = new ArrayList<String>(_list7.size);
                String _elem8;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.child_counters_map = new HashMap<String,Set<String>>(2*_map10.size);
                String _key11;
                Set<String> _val12;
                for (int _i13 = 0; _i13 < _map10.size; ++_i13)
                {
                  _key11 = iprot.readString();
                  {
                    ...
                    _val12 = new HashSet<String>(2*_set14.size);
                    String _elem15;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.info_strings != null) {
        oprot.writeFieldBegin(INFO_STRINGS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter18 : struct.info_strings.entrySet())
          {
      ...
      if (struct.info_strings_display_order != null) {
        oprot.writeFieldBegin(INFO_STRINGS_DISPLAY_ORDER_FIELD_DESC);
        {
          ...
          for (String _iter19 : struct.info_strings_display_order)
          {
      ...
      if (struct.child_counters_map != null) {
        oprot.writeFieldBegin(CHILD_COUNTERS_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Set<String>> _iter20 : struct.child_counters_map.entrySet())
          {
            oprot.writeString(_iter20.getKey());
            {
              ...
              for (String _iter21 : _iter20.getValue())
              {
  ...
  private static class TRuntimeProfileNodeTupleScheme extends TupleScheme<TRuntimeProfileNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeBool(struct.indent);
      {
        ...
        for (Map.Entry<String, String> _iter23 : struct.info_strings.entrySet())
        {
      ...
      }
      {
        ...
        for (String _iter24 : struct.info_strings_display_order)
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Set<String>> _iter25 : struct.child_counters_map.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      struct.setNum_childrenIsSet(true);
      {
        ...
        struct.counters = new ArrayList<TCounter>(_list27.size);
        TCounter _elem28;
      ...
      struct.setIndentIsSet(true);
      {
        ...
        struct.info_strings = new HashMap<String,String>(2*_map30.size);
        String _key31;
        String _val32;
      ...
      struct.setInfo_stringsIsSet(true);
      {
        ...
        struct.info_strings_display_order = new ArrayList<String>(_list34.size);
        String _elem35;
      ...
      struct.setInfo_strings_display_orderIsSet(true);
      {
        ...
        struct.child_counters_map = new HashMap<String,Set<String>>(2*_map37.size);
        String _key38;
        Set<String> _val39;
        for (int _i40 = 0; _i40 < _map37.size; ++_i40)
        {
          _key38 = iprot.readString();
          {
            ...
            _val39 = new HashSet<String>(2*_set41.size);
            String _elem42;

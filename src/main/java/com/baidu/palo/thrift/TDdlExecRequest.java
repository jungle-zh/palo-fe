...
public class TDdlExecRequest implements org.apache.thrift.TBase<TDdlExecRequest, TDdlExecRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TDdlExecRequest> {
  ...
  public TExplainParams explain_params; // optional
  public TSetParams set_params; // optional
  public TKillParams kill_params; // optional
  ...
  public TDdlExecRequest setExplain_params(TExplainParams explain_params) {
  ...
  public TDdlExecRequest setSet_params(TSetParams set_params) {
  ...
  public TDdlExecRequest setKill_params(TKillParams kill_params) {
  ...
  public int hashCode() {
    ...
    boolean present_explain_params = true && (isSetExplain_params());
    list.add(present_explain_params);
    if (present_explain_params)
      list.add(explain_params);

    boolean present_set_params = true && (isSetSet_params());
    list.add(present_set_params);
    if (present_set_params)
      list.add(set_params);

    boolean present_kill_params = true && (isSetKill_params());
    list.add(present_kill_params);
    if (present_kill_params)
      list.add(kill_params);
  ...
  public int compareTo(TDdlExecRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetExplain_params()).compareTo(other.isSetExplain_params());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSet_params()).compareTo(other.isSetSet_params());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSet_params()) {
    ...
    lastComparison = Boolean.valueOf(isSetKill_params()).compareTo(other.isSetKill_params());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetKill_params()) {
        ...
        switch (schemeField.id) {
          case 1: // DDL_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.ddl_type = com.baidu.palo.thrift.TDdlType.findByValue(iprot.readI32());

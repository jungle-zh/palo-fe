...
public class TExecRequest implements org.apache.thrift.TBase<TExecRequest, TExecRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TExecRequest> {
  ...
  public String sql_stmt; // optional
  public com.baidu.palo.thrift.TUniqueId request_id; // required
  public com.baidu.palo.thrift.TQueryOptions query_options; // required
  ...
  public TExecRequest(
    ...
    com.baidu.palo.thrift.TUniqueId request_id,
    com.baidu.palo.thrift.TQueryOptions query_options)
  {
    this();
  ...
  public TExecRequest(TExecRequest other) {
    ...
    if (other.isSetRequest_id()) {
      this.request_id = new com.baidu.palo.thrift.TUniqueId(other.request_id);
    }
    if (other.isSetQuery_options()) {
      this.query_options = new com.baidu.palo.thrift.TQueryOptions(other.query_options);
    }
   ...
   * @see com.baidu.palo.thrift.TStmtType
   */
  public TExecRequest setStmt_type(com.baidu.palo.thrift.TStmtType stmt_type) {
    this.stmt_type = stmt_type;
    return this;
  }
  ...
  public TExecRequest setSql_stmt(String sql_stmt) {
  ...
  public com.baidu.palo.thrift.TUniqueId getRequest_id() {
    return this.request_id;
  }

  public TExecRequest setRequest_id(com.baidu.palo.thrift.TUniqueId request_id) {
    this.request_id = request_id;
    return this;
  }
  ...
  public com.baidu.palo.thrift.TQueryOptions getQuery_options() {
    return this.query_options;
  }

  public TExecRequest setQuery_options(com.baidu.palo.thrift.TQueryOptions query_options) {
    this.query_options = query_options;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case REQUEST_ID:
      if (value == null) {
        ...
        setRequest_id((com.baidu.palo.thrift.TUniqueId)value);
      }
      break;
    ...
    case QUERY_OPTIONS:
      if (value == null) {
        ...
        setQuery_options((com.baidu.palo.thrift.TQueryOptions)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_sql_stmt = true && (isSetSql_stmt());
    list.add(present_sql_stmt);
    if (present_sql_stmt)
      list.add(sql_stmt);
    ...
    boolean present_ddl_exec_request = true && (isSetDdl_exec_request());
    list.add(present_ddl_exec_request);
    if (present_ddl_exec_request)
      list.add(ddl_exec_request);
  ...
  public int compareTo(TExecRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetSql_stmt()).compareTo(other.isSetSql_stmt());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSql_stmt()) {
    ...
    lastComparison = Boolean.valueOf(isSetDdl_exec_request()).compareTo(other.isSetDdl_exec_request());
    if (lastComparison != 0) {
      return lastComparison;
    }
        ...
        switch (schemeField.id) {
          ...
          case 3: // REQUEST_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.request_id = new com.baidu.palo.thrift.TUniqueId();
          ...
          case 4: // QUERY_OPTIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.query_options = new com.baidu.palo.thrift.TQueryOptions();

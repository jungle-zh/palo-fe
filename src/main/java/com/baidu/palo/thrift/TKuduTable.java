            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.master_addresses = new ArrayList<String>(_list40.size);
                String _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = iprot.readString();
                  struct.master_addresses.add(_elem41);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.key_columns = new ArrayList<String>(_list43.size);
                String _elem44;
                for (int _i45 = 0; _i45 < _list43.size; ++_i45)
                {
                  _elem44 = iprot.readString();
                  struct.key_columns.add(_elem44);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_by = new ArrayList<TKuduPartitionParam>(_list46.size);
                TKuduPartitionParam _elem47;
                for (int _i48 = 0; _i48 < _list46.size; ++_i48)
                {
                  _elem47 = new TKuduPartitionParam();
                  _elem47.read(iprot);
                  struct.partition_by.add(_elem47);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TKuduTable struct) throws org.apache.thrift.TException {
      ...
      if (struct.master_addresses != null) {
        oprot.writeFieldBegin(MASTER_ADDRESSES_FIELD_DESC);
        {
          ...
          for (String _iter49 : struct.master_addresses)
          {
      ...
      if (struct.key_columns != null) {
        oprot.writeFieldBegin(KEY_COLUMNS_FIELD_DESC);
        {
          ...
          for (String _iter50 : struct.key_columns)
          {
      ...
      if (struct.partition_by != null) {
        oprot.writeFieldBegin(PARTITION_BY_FIELD_DESC);
        {
          ...
          for (TKuduPartitionParam _iter51 : struct.partition_by)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TKuduTableTupleScheme extends TupleScheme<TKuduTable> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TKuduTable struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.table_name);
      {
        ...
        for (String _iter52 : struct.master_addresses)
        {
      ...
      }
      {
        ...
        for (String _iter53 : struct.key_columns)
        {
      ...
      }
      {
        ...
        for (TKuduPartitionParam _iter54 : struct.partition_by)
        {
          _iter54.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TKuduTable struct) throws org.apache.thrift.TException {
      ...
      struct.setTable_nameIsSet(true);
      {
        ...
        struct.master_addresses = new ArrayList<String>(_list55.size);
        String _elem56;
        for (int _i57 = 0; _i57 < _list55.size; ++_i57)
        {
          _elem56 = iprot.readString();
          struct.master_addresses.add(_elem56);
        }
      }
      struct.setMaster_addressesIsSet(true);
      {
        ...
        struct.key_columns = new ArrayList<String>(_list58.size);
        String _elem59;
        for (int _i60 = 0; _i60 < _list58.size; ++_i60)
        {
          _elem59 = iprot.readString();
          struct.key_columns.add(_elem59);
        }
      }
      struct.setKey_columnsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list61 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.partition_by = new ArrayList<TKuduPartitionParam>(_list61.size);
        TKuduPartitionParam _elem62;
        for (int _i63 = 0; _i63 < _list61.size; ++_i63)
        {
          _elem62 = new TKuduPartitionParam();
          _elem62.read(iprot);
          struct.partition_by.add(_elem62);
        }
      }
      struct.setPartition_byIsSet(true);
    }

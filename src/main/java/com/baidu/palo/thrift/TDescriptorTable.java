            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.slotDescriptors = new ArrayList<TSlotDescriptor>(_list64.size);
                TSlotDescriptor _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = new TSlotDescriptor();
                  _elem65.read(iprot);
                  struct.slotDescriptors.add(_elem65);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tupleDescriptors = new ArrayList<TTupleDescriptor>(_list67.size);
                TTupleDescriptor _elem68;
                for (int _i69 = 0; _i69 < _list67.size; ++_i69)
                {
                  _elem68 = new TTupleDescriptor();
                  _elem68.read(iprot);
                  struct.tupleDescriptors.add(_elem68);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableDescriptors = new ArrayList<TTableDescriptor>(_list70.size);
                TTableDescriptor _elem71;
                for (int _i72 = 0; _i72 < _list70.size; ++_i72)
                {
                  _elem71 = new TTableDescriptor();
                  _elem71.read(iprot);
                  struct.tableDescriptors.add(_elem71);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDescriptorTable struct) throws org.apache.thrift.TException {
      ...
      if (struct.slotDescriptors != null) {
        if (struct.isSetSlotDescriptors()) {
          oprot.writeFieldBegin(SLOT_DESCRIPTORS_FIELD_DESC);
          {
            ...
            for (TSlotDescriptor _iter73 : struct.slotDescriptors)
            {
              _iter73.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.tupleDescriptors != null) {
        oprot.writeFieldBegin(TUPLE_DESCRIPTORS_FIELD_DESC);
        {
          ...
          for (TTupleDescriptor _iter74 : struct.tupleDescriptors)
          {
            _iter74.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.tableDescriptors != null) {
        if (struct.isSetTableDescriptors()) {
          oprot.writeFieldBegin(TABLE_DESCRIPTORS_FIELD_DESC);
          {
            ...
            for (TTableDescriptor _iter75 : struct.tableDescriptors)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TDescriptorTableTupleScheme extends TupleScheme<TDescriptorTable> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TDescriptorTable struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (TTupleDescriptor _iter76 : struct.tupleDescriptors)
        {
          _iter76.write(oprot);
        }
      }
      ...
      if (struct.isSetSlotDescriptors()) {
        {
          ...
          for (TSlotDescriptor _iter77 : struct.slotDescriptors)
          {
            _iter77.write(oprot);
          }
        }
      ...
      if (struct.isSetTableDescriptors()) {
        {
          ...
          for (TTableDescriptor _iter78 : struct.tableDescriptors)
          {
            _iter78.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDescriptorTable struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.tupleDescriptors = new ArrayList<TTupleDescriptor>(_list79.size);
        TTupleDescriptor _elem80;
        for (int _i81 = 0; _i81 < _list79.size; ++_i81)
        {
          _elem80 = new TTupleDescriptor();
          _elem80.read(iprot);
          struct.tupleDescriptors.add(_elem80);
        }
      }
      struct.setTupleDescriptorsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.slotDescriptors = new ArrayList<TSlotDescriptor>(_list82.size);
          TSlotDescriptor _elem83;
          for (int _i84 = 0; _i84 < _list82.size; ++_i84)
          {
            _elem83 = new TSlotDescriptor();
            _elem83.read(iprot);
            struct.slotDescriptors.add(_elem83);
          }
        }
        struct.setSlotDescriptorsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.tableDescriptors = new ArrayList<TTableDescriptor>(_list85.size);
          TTableDescriptor _elem86;
          for (int _i87 = 0; _i87 < _list85.size; ++_i87)
          {
            _elem86 = new TTableDescriptor();
            _elem86.read(iprot);
            struct.tableDescriptors.add(_elem86);
          }
        }
        struct.setTableDescriptorsIsSet(true);
      }

...
public class TCheckConsistencyReq implements org.apache.thrift.TBase<TCheckConsistencyReq, TCheckConsistencyReq._Fields>, java.io.Serializable, Cloneable, Comparable<TCheckConsistencyReq> {
  ...
  static {
    schemes.put(StandardScheme.class, new TCheckConsistencyReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TCheckConsistencyReqTupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TCheckConsistencyReq(");
    boolean first = true;
  ...
  private static class TCheckConsistencyReqStandardSchemeFactory implements SchemeFactory {
    public TCheckConsistencyReqStandardScheme getScheme() {
      return new TCheckConsistencyReqStandardScheme();
    }
  }

  private static class TCheckConsistencyReqStandardScheme extends StandardScheme<TCheckConsistencyReq> {
  ...
  private static class TCheckConsistencyReqTupleSchemeFactory implements SchemeFactory {
    public TCheckConsistencyReqTupleScheme getScheme() {
      return new TCheckConsistencyReqTupleScheme();
    }
  }

  private static class TCheckConsistencyReqTupleScheme extends TupleScheme<TCheckConsistencyReq> {

...
public class TDropTabletReq implements org.apache.thrift.TBase<TDropTabletReq, TDropTabletReq._Fields>, java.io.Serializable, Cloneable, Comparable<TDropTabletReq> {
  ...
  static {
    schemes.put(StandardScheme.class, new TDropTabletReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TDropTabletReqTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.SCHEMA_HASH};
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TDropTabletReq(");
    boolean first = true;
  ...
  private static class TDropTabletReqStandardSchemeFactory implements SchemeFactory {
    public TDropTabletReqStandardScheme getScheme() {
      return new TDropTabletReqStandardScheme();
    }
  }

  private static class TDropTabletReqStandardScheme extends StandardScheme<TDropTabletReq> {
  ...
  private static class TDropTabletReqTupleSchemeFactory implements SchemeFactory {
    public TDropTabletReqTupleScheme getScheme() {
      return new TDropTabletReqTupleScheme();
    }
  }

  private static class TDropTabletReqTupleScheme extends TupleScheme<TDropTabletReq> {
